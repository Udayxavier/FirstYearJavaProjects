...
/* 
This program uses the constructor of your QuadrantTree class to build the tree shown in page 4 of the assignment. Note that the node ID's are not part of the assignment; they assigned by the code to make it easier for you to check whether the tree built by your code is correct. 
*/          
